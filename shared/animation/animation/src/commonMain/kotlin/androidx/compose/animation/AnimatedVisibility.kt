 ...
 * the [AnimatedVisibility] composable is put in a [com.huanli233.hibari2.foundation.layout.Row] or a [com.huanli233.hibari2.foundation.layout.Column], the default enter and exit
 ...
 * when the [AnimatedVisibility] is in a [com.huanli233.hibari2.foundation.layout.Row]. The default animations are tailored specific to the
 * [com.huanli233.hibari2.foundation.layout.Row] layout. See more details below.
 *
 ...
 * [com.huanli233.hibari2.foundation.layout.Row]. [enter] defaults to a combination of fading in and expanding the content horizontally.
 ...
 * AnimatedVisibility API variant that takes a [MutableTransitionState] parameter.
 *
 * Here's an example of using [RowScope.AnimatedVisibility] in a [com.huanli233.hibari2.foundation.layout.Row]:
 *
 ...
 * content when the [AnimatedVisibility] is in a [com.huanli233.hibari2.foundation.layout.Column]. The default animations are tailored
 * specific to the [com.huanli233.hibari2.foundation.layout.Column] layout. See more details below.
 *
 * Different [EnterTransition]s and [ExitTransition]s can be defined in [enter] and [exit] for the
 * appearance and disappearance animation. There are 4 types of [EnterTransition] and
 * [ExitTransition]: Fade, Expand/Shrink, Scale and Slide. The enter transitions can be combined
 ...
 * [com.huanli233.hibari2.foundation.layout.Column]. [enter] defaults to a combination of fading in and expanding the content vertically.
 ...
 * AnimatedVisibility API variant that takes a [MutableTransitionState] parameter.
 *
 * Here's an example of using [ColumnScope.AnimatedVisibility] in a [com.huanli233.hibari2.foundation.layout.Column]:
 *
 ...
 * [enter] and [exit] transitions are tailored specific to the [com.huanli233.hibari2.foundation.layout.Row] layout. See more details below.
 ...
 * default [enter] and [exit] transitions are tailored specific to the [com.huanli233.hibari2.foundation.layout.Column] layout. See more
