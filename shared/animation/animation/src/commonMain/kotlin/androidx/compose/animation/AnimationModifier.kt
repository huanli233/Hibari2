...
import com.huanli233.hibari2.core.modifier.LayoutModifierNode
...
private class SizeAnimationModifierNode(
    ...
    fun animateTo(targetSize: IntSize): IntSize {
        ...
        animData = data
        return data.anim.value.also {
            Log.d("huanli233", "<- [LogModifier 'SizeAnimationModifierNode'] animateTo value: (${it})")
        }
    }
}
