...
import com.huanli233.hibari2.foundation.layout.ContextualFlowRowOverflow.Companion.Clip
import com.huanli233.hibari2.foundation.layout.ContextualFlowRowOverflow.Companion.Visible
import com.huanli233.hibari2.foundation.layout.FlowColumnOverflow.Companion.Clip
import com.huanli233.hibari2.foundation.layout.FlowColumnOverflow.Companion.Visible
import com.huanli233.hibari2.foundation.layout.FlowColumnOverflow.Companion.expandIndicator
import com.huanli233.hibari2.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator
import com.huanli233.hibari2.foundation.layout.FlowRowOverflow.Companion.Clip
import com.huanli233.hibari2.foundation.layout.FlowRowOverflow.Companion.expandIndicator
import com.huanli233.hibari2.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator
import androidx.compose.runtime.Composable
import androidx.compose.runtime.remember
import com.huanli233.hibari2.core.layout.IntrinsicMeasurable
import com.huanli233.hibari2.core.layout.Measurable
import com.huanli233.hibari2.core.layout.Placeable
    ...
    companion object {
        ...
        fun expandIndicator(content: @Composable FlowRowOverflowScope.() -> Unit): FlowRowOverflow {
            val seeMoreGetter = { state: FlowLayoutOverflowState ->
                @Composable {
                    val scope =
                        _root_ide_package_.com.huanli233.hibari2.foundation.layout.FlowRowOverflowScopeImpl(
                            state
                        )
                    scope.content()
                }
...
private constructor(
    ...
    companion object {
        /** Display all content, even if there is not enough space in the specified bounds. */
        @ExperimentalLayoutApi
        val Visible = FlowColumnOverflow(OverflowType.Visible)

        /** Clip the overflowing content to fix its container. */
        @ExperimentalLayoutApi
        val Clip = FlowColumnOverflow(OverflowType.Clip)
        ...
        fun expandIndicator(
            ...
            val seeMoreGetter = { state: FlowLayoutOverflowState ->
                @Composable {
                    val scope =
                        _root_ide_package_.com.huanli233.hibari2.foundation.layout.FlowColumnOverflowScopeImpl(
                            state
                        )
                    scope.content()
                }
...
private constructor(
    ...
    companion object {
        /** Display all content, even if there is not enough space in the specified bounds. */
        @ExperimentalLayoutApi
        val Visible = ContextualFlowRowOverflow(OverflowType.Visible)

        /** Clip the overflowing content to fix its container. */
        @ExperimentalLayoutApi
        val Clip = ContextualFlowRowOverflow(OverflowType.Clip)
...
private constructor(
    ...
    companion object {
        /** Display all content, even if there is not enough space in the specified bounds. */
        @ExperimentalLayoutApi
        val Visible = ContextualFlowColumnOverflow(OverflowType.Visible)

        /** Clip the overflowing content to fix its container. */
        @ExperimentalLayoutApi
        val Clip = ContextualFlowColumnOverflow(OverflowType.Clip)
