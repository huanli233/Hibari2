...
import com.huanli233.hibari2.foundation.layout.internal.requirePrecondition
...
import com.huanli233.hibari2.core.layout.IntrinsicMeasureScope
...
import com.huanli233.hibari2.core.layout.MultiContentMeasurePolicy
 ...
 * by [com.huanli233.hibari2.core.layout.FirstBaseline]. If, however, you need to align Texts by
 * [com.huanli233.hibari2.core.layout.LastBaseline] for example, use a more general [RowScope.alignBy]
 * modifier.
 *
...
fun FlowRow(
    ...
    overflow: FlowRowOverflow = FlowRowOverflow.Companion.Clip,
...
fun FlowRow(
    ...
    FlowRow(
        ...
        maxItemsInEachRow,
        maxLines,
        FlowRowOverflow.Companion.Clip,
        content,
    )
...
fun FlowColumn(
    ...
    maxLines: Int = Int.MAX_VALUE,
    overflow: FlowColumnOverflow = FlowColumnOverflow.Companion.Clip,
...
fun FlowColumn(
    ...
    FlowColumn(
        ...
        maxItemsInEachColumn,
        maxLines,
        FlowColumnOverflow.Companion.Clip,
        content,
    )
    ...
    return remember(horizontalArrangement, verticalArrangement, maxItemsInMainAxis) {
        val measurePolicy =
            FlowMeasurePolicy(
                ...
                overflow = FlowRowOverflow.Companion.Visible.createOverflowState(),
            )
...
internal fun rowMeasurementMultiContentHelper(
    ...
    return remember(
        ...
        FlowMeasurePolicy(
            ...
            horizontalArrangement = horizontalArrangement,
            mainAxisSpacing = horizontalArrangement.spacing,
            crossAxisAlignment = CrossAxisAlignment.Companion.vertical(itemVerticalAlignment),
            verticalArrangement = verticalArrangement,
            crossAxisArrangementSpacing = verticalArrangement.spacing,
            maxItemsInMainAxis = maxItemsInMainAxis,
            maxLines = maxLines,
...
internal fun columnMeasurementMultiContentHelper(
    ...
    return remember(
        ...
        FlowMeasurePolicy(
            ...
            verticalArrangement = verticalArrangement,
            mainAxisSpacing = verticalArrangement.spacing,
            crossAxisAlignment = CrossAxisAlignment.Companion.horizontal(itemHorizontalAlignment),
            horizontalArrangement = horizontalArrangement,
            crossAxisArrangementSpacing = horizontalArrangement.spacing,
            maxItemsInMainAxis = maxItemsInMainAxis,
            maxLines = maxLines,
...
internal val CROSS_AXIS_ALIGNMENT_TOP = CrossAxisAlignment.Companion.vertical(Alignment.Top)
internal val CROSS_AXIS_ALIGNMENT_START = CrossAxisAlignment.Companion.horizontal(Alignment.Start)
