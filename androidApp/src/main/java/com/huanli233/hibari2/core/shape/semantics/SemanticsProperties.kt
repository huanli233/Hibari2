...
object SemanticsProperties {
    /** @see com.huanli233.hibari2.core.semantics.contentDescription */
    ...
    /** @see com.huanli233.hibari2.core.semantics.stateDescription */
    val StateDescription = AccessibilityKey<String>("StateDescription")

    /** @see com.huanli233.hibari2.core.semantics.progressBarRangeInfo */
    val ProgressBarRangeInfo = AccessibilityKey<com.huanli233.hibari2.core.semantics.ProgressBarRangeInfo>("ProgressBarRangeInfo")

    /** @see com.huanli233.hibari2.core.semantics.paneTitle */
    val PaneTitle =
    ...
    /** @see com.huanli233.hibari2.core.semantics.selectableGroup */
    val SelectableGroup = AccessibilityKey<Unit>("SelectableGroup")

    /** @see com.huanli233.hibari2.core.semantics.collectionInfo */
    val CollectionInfo = AccessibilityKey<com.huanli233.hibari2.core.semantics.CollectionInfo>("CollectionInfo")

    /** @see com.huanli233.hibari2.core.semantics.collectionItemInfo */
    val CollectionItemInfo = AccessibilityKey<com.huanli233.hibari2.core.semantics.CollectionItemInfo>("CollectionItemInfo")

    /** @see com.huanli233.hibari2.core.semantics.heading */
    val Heading = AccessibilityKey<Unit>("Heading")

    /** @see com.huanli233.hibari2.core.semantics.disabled */
    val Disabled = AccessibilityKey<Unit>("Disabled")

    /** @see com.huanli233.hibari2.core.semantics.liveRegion */
    val LiveRegion = AccessibilityKey<com.huanli233.hibari2.core.semantics.LiveRegionMode>("LiveRegion")

    /** @see com.huanli233.hibari2.core.semantics.focused */
    val Focused = AccessibilityKey<Boolean>("Focused")

    /** @see com.huanli233.hibari2.core.semantics.isContainer */
    ...
    /** @see com.huanli233.hibari2.core.semantics.isTraversalGroup */
    val IsTraversalGroup =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Boolean>("IsTraversalGroup")

    /** @see com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.IsSensitiveData */
    val IsSensitiveData =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Boolean>("IsSensitiveData")

    /** @see com.huanli233.hibari2.core.semantics.invisibleToUser */
    @Deprecated(
    ...
    val InvisibleToUser =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Unit>(
            name = "InvisibleToUser",
            mergePolicy = { parentValue, _ -> parentValue },
        )

    /** @see com.huanli233.hibari2.core.semantics.hideFromAccessibility */
    ...
    /** @see com.huanli233.hibari2.core.semantics.contentType */
    val ContentType =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<ContentType>(
            name = "ContentType",
    ...
    /** @see com.huanli233.hibari2.core.semantics.contentDataType */
    val ContentDataType =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<ContentDataType>(
    ...
    /** @see com.huanli233.hibari2.core.semantics.traversalIndex */
    val TraversalIndex =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Float>(
            name = "TraversalIndex",
            mergePolicy = { parentValue, _ ->
    ...
    /** @see com.huanli233.hibari2.core.semantics.horizontalScrollAxisRange */
    val HorizontalScrollAxisRange = AccessibilityKey<com.huanli233.hibari2.core.semantics.ScrollAxisRange>("HorizontalScrollAxisRange")

    /** @see com.huanli233.hibari2.core.semantics.verticalScrollAxisRange */
    val VerticalScrollAxisRange = AccessibilityKey<com.huanli233.hibari2.core.semantics.ScrollAxisRange>("VerticalScrollAxisRange")

    /** @see com.huanli233.hibari2.core.semantics.popup */
    val IsPopup =
    ...
    /** @see com.huanli233.hibari2.core.semantics.dialog */
    val IsDialog =
        AccessibilityKey<Unit>(
            name = "IsDialog",
            mergePolicy = { _, _ ->
     ...
     *
     * @see com.huanli233.hibari2.core.semantics.role
     */
    val Role = AccessibilityKey<com.huanli233.hibari2.core.semantics.Role>("Role") { parentValue, _ -> parentValue }

    /** @see com.huanli233.hibari2.core.semantics.testTag */
    val TestTag =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<String>(
            name = "TestTag",
    ...
    /** @see com.huanli233.hibari2.core.semantics.text */
    val Text =
    ...
    /** @see com.huanli233.hibari2.core.semantics.textSubstitution */
    val TextSubstitution =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<AnnotatedString>(
            name = "TextSubstitution"
        )

    /** @see com.huanli233.hibari2.core.semantics.isShowingTextSubstitution */
    val IsShowingTextSubstitution =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Boolean>("IsShowingTextSubstitution")

    /** @see com.huanli233.hibari2.core.semantics.inputText */
    val InputText = AccessibilityKey<AnnotatedString>(name = "InputText")

    /** @see com.huanli233.hibari2.core.semantics.editableText */
    val EditableText = AccessibilityKey<AnnotatedString>(name = "EditableText")

    /** @see com.huanli233.hibari2.core.semantics.textSelectionRange */
    val TextSelectionRange = AccessibilityKey<TextRange>("TextSelectionRange")

    /** @see com.huanli233.hibari2.core.semantics.onImeAction */
    val ImeAction = AccessibilityKey<ImeAction>("ImeAction")

    /** @see com.huanli233.hibari2.core.semantics.selected */
    val Selected = AccessibilityKey<Boolean>("Selected")

    /** @see com.huanli233.hibari2.core.semantics.toggleableState */
    val ToggleableState = AccessibilityKey<ToggleableState>("ToggleableState")

    /** @see com.huanli233.hibari2.core.semantics.password */
    val Password = AccessibilityKey<Unit>("Password")

    /** @see com.huanli233.hibari2.core.semantics.error */
    val Error = AccessibilityKey<String>("Error")

    /** @see com.huanli233.hibari2.core.semantics.indexForKey */
    val IndexForKey =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<(Any) -> Int>("IndexForKey")

    /** @see com.huanli233.hibari2.core.semantics.isEditable */
    val IsEditable =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Boolean>("IsEditable")

    /** @see com.huanli233.hibari2.core.semantics.maxTextLength */
    val MaxTextLength =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Int>("MaxTextLength")

    /** @see com.huanli233.hibari2.core.semantics.shape */
    val Shape =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<Shape>(
            name = "Shape",
            isImportantForAccessibility = false,
            mergePolicy = { parentValue, _ ->
                // Never merge shapes
...
object SemanticsActions {
    /** @see com.huanli233.hibari2.core.semantics.getTextLayoutResult */
    val GetTextLayoutResult =
        ActionPropertyKey<(MutableList<TextLayoutResult>) -> Boolean>("GetTextLayoutResult")

    /** @see com.huanli233.hibari2.core.semantics.onClick */
    val OnClick = ActionPropertyKey<() -> Boolean>("OnClick")

    /** @see com.huanli233.hibari2.core.semantics.onLongClick */
    val OnLongClick = ActionPropertyKey<() -> Boolean>("OnLongClick")

    /** @see com.huanli233.hibari2.core.semantics.scrollBy */
    val ScrollBy = ActionPropertyKey<(x: Float, y: Float) -> Boolean>("ScrollBy")

    /** @see com.huanli233.hibari2.core.semantics.scrollByOffset */
    val ScrollByOffset =
        _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<suspend (offset: Offset) -> Offset>(
            "ScrollByOffset"
        )

    /** @see com.huanli233.hibari2.core.semantics.scrollToIndex */
    val ScrollToIndex = ActionPropertyKey<(Int) -> Boolean>("ScrollToIndex")

    /** @see com.huanli233.hibari2.core.semantics.onAutofillText */
    val OnAutofillText = ActionPropertyKey<(AnnotatedString) -> Boolean>("OnAutofillText")

    /** @see com.huanli233.hibari2.core.semantics.setProgress */
    val SetProgress = ActionPropertyKey<(progress: Float) -> Boolean>("SetProgress")

    /** @see com.huanli233.hibari2.core.semantics.setSelection */
    val SetSelection = ActionPropertyKey<(Int, Int, Boolean) -> Boolean>("SetSelection")

    /** @see com.huanli233.hibari2.core.semantics.setText */
    val SetText = ActionPropertyKey<(AnnotatedString) -> Boolean>("SetText")

    /** @see com.huanli233.hibari2.core.semantics.setTextSubstitution */
    val SetTextSubstitution = ActionPropertyKey<(AnnotatedString) -> Boolean>("SetTextSubstitution")

    /** @see com.huanli233.hibari2.core.semantics.showTextSubstitution */
    val ShowTextSubstitution = ActionPropertyKey<(Boolean) -> Boolean>("ShowTextSubstitution")

    /** @see com.huanli233.hibari2.core.semantics.clearTextSubstitution */
    val ClearTextSubstitution = ActionPropertyKey<() -> Boolean>("ClearTextSubstitution")

    /** @see com.huanli233.hibari2.core.semantics.insertTextAtCursor */
    ...
    /** @see com.huanli233.hibari2.core.semantics.copyText */
    val CopyText = ActionPropertyKey<() -> Boolean>("CopyText")

    /** @see com.huanli233.hibari2.core.semantics.cutText */
    val CutText = ActionPropertyKey<() -> Boolean>("CutText")

    /** @see com.huanli233.hibari2.core.semantics.pasteText */
    val PasteText = ActionPropertyKey<() -> Boolean>("PasteText")

    /** @see com.huanli233.hibari2.core.semantics.expand */
    val Expand = ActionPropertyKey<() -> Boolean>("Expand")

    /** @see com.huanli233.hibari2.core.semantics.collapse */
    val Collapse = ActionPropertyKey<() -> Boolean>("Collapse")

    /** @see com.huanli233.hibari2.core.semantics.dismiss */
    val Dismiss = ActionPropertyKey<() -> Boolean>("Dismiss")

    /** @see com.huanli233.hibari2.core.semantics.requestFocus */
    val RequestFocus = ActionPropertyKey<() -> Boolean>("RequestFocus")

    /** @see com.huanli233.hibari2.core.semantics.customActions */
    val CustomActions = AccessibilityKey<List<com.huanli233.hibari2.core.semantics.CustomAccessibilityAction>>("CustomActions")

    /** @see com.huanli233.hibari2.core.semantics.pageUp */
    val PageUp = ActionPropertyKey<() -> Boolean>("PageUp")

    /** @see com.huanli233.hibari2.core.semantics.pageLeft */
    val PageLeft = ActionPropertyKey<() -> Boolean>("PageLeft")

    /** @see com.huanli233.hibari2.core.semantics.pageDown */
    val PageDown = ActionPropertyKey<() -> Boolean>("PageDown")

    /** @see com.huanli233.hibari2.core.semantics.pageRight */
    val PageRight = ActionPropertyKey<() -> Boolean>("PageRight")

    /** @see com.huanli233.hibari2.core.semantics.getScrollViewportLength */
...
class SemanticsPropertyKey<T>(
    ...
    final operator fun getValue(thisRef: com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver, property: KProperty<*>): T {
        return throwSemanticsGetNotSupported()
    }

    final operator fun setValue(
        thisRef: com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver,
        property: KProperty<*>,
        value: T,
    ) {
        thisRef[this] = value
...
internal inline fun <T> AccessibilityKey(name: String) =
    _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<T>(
        name = name,
...
internal inline fun <T> AccessibilityKey(name: String, noinline mergePolicy: (T?, T) -> T?) =
    _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsPropertyKey(
        name = name,
        isImportantForAccessibility = true,
...
class AccessibilityAction<T : Function<Boolean>>(val label: String?, val action: T?) {
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is com.huanli233.hibari2.core.semantics.AccessibilityAction<*>) return false
...
private inline fun <T : Function<Boolean>> ActionPropertyKey(name: String) =
    AccessibilityKey<com.huanli233.hibari2.core.semantics.AccessibilityAction<T>>(
        name = name,
        mergePolicy = { parentValue, childValue ->
...
class CustomAccessibilityAction(val label: String, val action: () -> Boolean) {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is com.huanli233.hibari2.core.semantics.CustomAccessibilityAction) return false
...
class ProgressBarRangeInfo(
    ...
    companion object {
        ...
        val Indeterminate =
            _root_ide_package_.com.huanli233.hibari2.core.semantics.ProgressBarRangeInfo(0f, 0f..0f)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is com.huanli233.hibari2.core.semantics.ProgressBarRangeInfo) return false
 ...
 * not listed, [com.huanli233.hibari2.core.semantics.role] should not be set and the framework will
 * automatically resolve it.
 */
@Immutable
...
value class Role private constructor(@Suppress("unused") private val value: Int) {
    companion object {
         ...
         * [com.huanli233.hibari2.core.semantics.SemanticsProperties.Disabled], [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val Button = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(0)
         ...
         * [com.huanli233.hibari2.core.semantics.SemanticsProperties.Disabled], [com.huanli233.hibari2.core.semantics.SemanticsProperties.StateDescription],
         * [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val Checkbox = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(1)
         ...
         * [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val Switch = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(2)
         ...
         * [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val RadioButton = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(3)
         ...
         * properties for accessibility: [com.huanli233.hibari2.core.semantics.SemanticsProperties.Disabled],
         * [com.huanli233.hibari2.core.semantics.SemanticsProperties.StateDescription], [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val Tab = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(4)

        /**
         * This element is an image. Associated semantics properties for accessibility:
         * [com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentDescription]
         */
        val Image = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(5)

        /**
         * This element is associated with a drop down menu. Associated semantics properties for
         * accessibility: [com.huanli233.hibari2.core.semantics.SemanticsActions.OnClick]
         */
        val DropdownList = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(6)
         ...
         */
        val ValuePicker = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(7)
         ...
         * [com.huanli233.hibari2.core.semantics.SemanticsActions.PageUp],[com.huanli233.hibari2.core.semantics.SemanticsActions.PageDown],[com.huanli233.hibari2.core.semantics.SemanticsActions.PageLeft],
         * [com.huanli233.hibari2.core.semantics.SemanticsActions.PageRight]
         */
        val Carousel = _root_ide_package_.com.huanli233.hibari2.core.semantics.Role(8)
    }
...
value class LiveRegionMode private constructor(@Suppress("unused") private val value: Int) {
    companion object {
         ...
         * node.
         */
        val Polite = _root_ide_package_.com.huanli233.hibari2.core.semantics.LiveRegionMode(0)
         ...
         */
        val Assertive = _root_ide_package_.com.huanli233.hibari2.core.semantics.LiveRegionMode(1)
    }
...
interface SemanticsPropertyReceiver {
    operator fun <T> set(key: com.huanli233.hibari2.core.semantics.SemanticsPropertyKey<T>, value: T)
}

/**
 * Developer-set content description of the semantics node.
 *
 * If this is not set, accessibility services will present the [text][com.huanli233.hibari2.core.semantics.SemanticsProperties.Text] of
 ...
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.contentDescription: String
    get() = throwSemanticsGetNotSupported()
    set(value) {
        set(_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentDescription, listOf(value))
    }
 ...
 * semantics properties, like [com.huanli233.hibari2.core.semantics.ProgressBarRangeInfo], but it is not guaranteed and the format will
 * be decided by accessibility services.
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.stateDescription by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.StateDescription
 ...
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.progressBarRangeInfo by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ProgressBarRangeInfo

/**
 * The node is marked as heading for accessibility.
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.Heading
 */
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.heading() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.Heading] = Unit
}
 ...
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.PaneTitle
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.paneTitle by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.PaneTitle

/**
 * Whether this semantics node is disabled. Note that proper [com.huanli233.hibari2.core.semantics.SemanticsActions] should still be
 * added when this property is set.
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.Disabled
 */
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.disabled() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.Disabled] = Unit
}
 ...
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.LiveRegion
 * @see com.huanli233.hibari2.core.semantics.LiveRegionMode
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.liveRegion by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.LiveRegion

/**
 * Whether this semantics node is focused. The presence of this property indicates this node is
 * focusable
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.Focused
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.focused by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.Focused
 ...
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.IsContainer
 */
@Deprecated("Use `isTraversalGroup` instead.", replaceWith = ReplaceWith("isTraversalGroup"))
@Suppress("DEPRECATION")
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.isContainer by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.IsContainer
 ...
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.IsTraversalGroup
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.isTraversalGroup by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.IsTraversalGroup
 ...
 * [com.huanli233.hibari2.core.semantics.SemanticsProperties.HideFromAccessibility] instead.
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.IsSensitiveData
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.isSensitiveData by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.IsSensitiveData
 ...
 * redundant with semantics of their parent, consider [com.huanli233.hibari2.core.semantics.clearAndSetSemantics]
 * instead.
 */
@Deprecated(
    "Use `hideFromAccessibility()` instead.",
...
@Suppress("DEPRECATION")
// Retain for binary compatibility with aosp/3341487 in 1.7
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.invisibleToUser() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.InvisibleToUser] = Unit
}
 ...
 * are redundant with semantics of their parent, consider [com.huanli233.hibari2.core.semantics.clearAndSetSemantics]
 * instead.
 */
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.hideFromAccessibility() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.HideFromAccessibility] = Unit
}
 ...
 *
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentType
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.contentType by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentType
 ...
 * @see com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentType
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.contentDataType by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentDataType
 ...
 * as well.
 */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.traversalIndex by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.TraversalIndex

/** The horizontal scroll state of this node if this node is scrollable. */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.horizontalScrollAxisRange by
    _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.HorizontalScrollAxisRange

/** The vertical scroll state of this node if this node is scrollable. */
var com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.verticalScrollAxisRange by _root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.VerticalScrollAxisRange

/**
 * Whether this semantics node represents a Popup. Not to be confused with if this node is _part of_
 * a Popup.
 */
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.popup() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.IsPopup] = Unit
}

/**
 * Whether this element is a Dialog. Not to be confused with if this element is _part of_ a Dialog.
 */
fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.dialog() {
    this[_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.IsDialog] = Unit
}
