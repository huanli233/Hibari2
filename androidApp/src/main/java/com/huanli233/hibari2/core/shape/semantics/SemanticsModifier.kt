...
import com.huanli233.hibari2.core.semantics.SemanticsModifier
...
internal class CoreSemanticsModifierNode(
    ...
    var properties: com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.() -> Unit,
 ...
 * [com.huanli233.hibari2.core.semantics.SemanticsPropertyKey]. Additionally, chaining multiple semantics modifiers is also a supported
 * style.
 *
 * The resulting semantics produce two [com.huanli233.hibari2.core.semantics.SemanticsNode] trees:
 *
 * The "unmerged tree" rooted at [com.huanli233.hibari2.core.semantics.SemanticsOwner.unmergedRootSemanticsNode] has one [com.huanli233.hibari2.core.semantics.SemanticsNode]
 * per layout node which has any [com.huanli233.hibari2.core.semantics.SemanticsModifier] on it. This [com.huanli233.hibari2.core.semantics.SemanticsNode] contains all the
 * properties set in all the [com.huanli233.hibari2.core.semantics.SemanticsModifier]s on that node.
 *
 * The "merged tree" rooted at [com.huanli233.hibari2.core.semantics.SemanticsOwner.rootSemanticsNode] has equal-or-fewer nodes: it
 * simplifies the structure based on [mergeDescendants] and [com.huanli233.hibari2.core.semantics.clearAndSetSemantics]. For most
 ...
 * @param properties properties to add to the semantics. [com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver] will be
...
internal class AppendedSemanticsElement(
    ...
    val properties: (com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.() -> Unit),
 ...
 *   result in an infinite loop.
 */
fun Modifier.clearAndSetSemantics(properties: (com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.() -> Unit)): Modifier =
    this then ClearAndSetSemanticsElement(properties)

// Implement SemanticsModifier to allow tooling to inspect the semantics configuration
internal class ClearAndSetSemanticsElement(val properties: com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.() -> Unit) :
    ModifierNodeElement<CoreSemanticsModifierNode>(), SemanticsModifier {
