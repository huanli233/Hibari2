...
/**
 * This is an internal interface that can be used by [com.huanli233.hibari2.core.semantics.SemanticsListener]s to read semantic
 * information from layout nodes. The root [com.huanli233.hibari2.core.semantics.SemanticsInfo] can be accessed using
 * [com.huanli233.hibari2.core.semantics.SemanticsOwner.rootInfo], and particular [com.huanli233.hibari2.core.semantics.SemanticsInfo] can be looked up by their [semanticsId]
 * by using [com.huanli233.hibari2.core.semantics.SemanticsOwner.get].
 */
internal interface SemanticsInfo : LayoutInfo {
    ...
    /**
     * The [com.huanli233.hibari2.core.semantics.SemanticsInfo] of the parent.
     *
