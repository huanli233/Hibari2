...
import com.huanli233.hibari2.core.semantics.SemanticsProperties.HideFromAccessibility
import com.huanli233.hibari2.core.semantics.SemanticsProperties.InvisibleToUser
import androidx.compose.ui.unit.IntRect
import androidx.compose.ui.unit.roundToIntRect
import androidx.compose.ui.util.fastForEach
import androidx.compose.ui.util.trace
import com.huanli233.hibari2.core.semantics.SemanticsConfiguration
import com.huanli233.hibari2.core.semantics.SemanticsOwner

/** Owns [com.huanli233.hibari2.core.semantics.SemanticsNode] objects and notifies listeners of changes to the semantics tree */
...
internal constructor(
     ...
     * data.
     */
    val rootSemanticsNode: com.huanli233.hibari2.core.semantics.SemanticsNode
        get() {
            return SemanticsNode(rootNode, mergingEnabled = true)
        }

    val unmergedRootSemanticsNode: com.huanli233.hibari2.core.semantics.SemanticsNode
        get() {
...
/**
 * Finds all [com.huanli233.hibari2.core.semantics.SemanticsNode]s in the tree owned by this [com.huanli233.hibari2.core.semantics.SemanticsOwner]. Return the results in a
 * list.
 *
 ...
 *   For example, the children of [com.huanli233.hibari2.core.layout.SubcomposeLayout] which are retained
...
/**
 * Finds all [com.huanli233.hibari2.core.semantics.SemanticsNode]s in the tree owned by this [SemanticsOwner]. Return the results in a
 * map.
 */
internal fun SemanticsOwner.getAllSemanticsNodesToMap(
    useUnmergedTree: Boolean = false,
    skipDeactivatedNodes: Boolean = true,
): Map<Int, com.huanli233.hibari2.core.semantics.SemanticsNode> {
    val nodes = mutableMapOf<Int, com.huanli233.hibari2.core.semantics.SemanticsNode>()

    fun findAllSemanticNodesRecursive(currentNode: com.huanli233.hibari2.core.semantics.SemanticsNode) {
...
internal fun com.huanli233.hibari2.core.semantics.SemanticsNode.isImportantForAccessibility() =
    !isHidden &&
        (unmergedConfig.isMergingSemanticsOfDescendants ||
            unmergedConfig.containsImportantForAccessibility())

@Suppress("DEPRECATION")
internal val com.huanli233.hibari2.core.semantics.SemanticsNode.isHidden: Boolean
...
internal class SemanticsNodeWithAdjustedBounds(
    val semanticsNode: com.huanli233.hibari2.core.semantics.SemanticsNode,
    val adjustedBounds: IntRect,
)

/**
 * Finds pruned [com.huanli233.hibari2.core.semantics.SemanticsNode]s in the tree owned by this [SemanticsOwner]. A semantics node
...
internal fun SemanticsOwner.getAllUncoveredSemanticsNodesToIntObjectMap(
    ...
    trace("getAllUncoveredSemanticsNodesToIntObjectMap") {
        ...
        fun findAllSemanticNodesRecursive(currentNode: com.huanli233.hibari2.core.semantics.SemanticsNode, region: com.huanli233.hibari2.core.semantics.SemanticsRegion) {
            ...
            if (region.intersect(unaccountedSpace)) {
                ...
                for (i in children.size - 1 downTo 0) {
                    ...
                    if (children[i].config.contains(_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.LinkTestMarker)) {
                        continue
                    }
