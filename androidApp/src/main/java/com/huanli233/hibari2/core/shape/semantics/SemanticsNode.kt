...
import com.huanli233.hibari2.core.layout.AlignmentLine
import com.huanli233.hibari2.core.layout.LayoutCoordinates
import com.huanli233.hibari2.core.layout.LayoutInfo
import com.huanli233.hibari2.core.layout.boundsInRoot
import com.huanli233.hibari2.core.layout.boundsInWindow
import com.huanli233.hibari2.core.layout.positionInRoot
import com.huanli233.hibari2.core.layout.positionInWindow
import com.huanli233.hibari2.core.layout.positionOnScreen
import com.huanli233.hibari2.core.node.LayoutNode
...
import com.huanli233.hibari2.core.semantics.SemanticsConfiguration
import kotlin.contracts.ExperimentalContracts
import kotlin.contracts.contract

internal fun SemanticsNode(layoutNode: LayoutNode, mergingEnabled: Boolean) =
    com.huanli233.hibari2.core.semantics.SemanticsNode(
...
internal constructor(
    ...
    private var fakeNodeParent: com.huanli233.hibari2.core.semantics.SemanticsNode? = null
    ...
    private fun mergeConfig(
        unmergedChildren: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode>,
    ...
    internal fun unmergedChildren(
        unmergedChildren: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode> = mutableListOf(),
        includeFakeNodes: Boolean = false,
        includeDeactivatedNodes: Boolean = false,
    ): List<com.huanli233.hibari2.core.semantics.SemanticsNode> {
    ...
    private fun LayoutNode.fillOneLayerOfSemanticsWrappers(
        list: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode>,
    ...
    // TODO(b/184376083): This is too expensive for a val (full subtree recreation every call);
    //               optimize this when the merging algorithm is improved.
    val children: List<com.huanli233.hibari2.core.semantics.SemanticsNode>
        get() = getChildren()
     ...
     * marked as [com.huanli233.hibari2.core.semantics.clearAndSetSemantics] will not have children. This property is primarily used in
     * Accessibility delegate.
     */
    internal val replacedChildren: List<com.huanli233.hibari2.core.semantics.SemanticsNode>
     ...
     *   [com.huanli233.hibari2.core.semantics.clearAndSetSemantics]. For accessibility we always use false, but in testing and debugging
     ...
     *   deactivated. For example, the children of [com.huanli233.hibari2.core.layout.SubcomposeLayout]
    ...
    internal fun getChildren(
        ...
        val unmergedChildren = mutableListOf<com.huanli233.hibari2.core.semantics.SemanticsNode>()
    ...
    val parent: com.huanli233.hibari2.core.semantics.SemanticsNode?
        get() {
    ...
    private fun findOneLayerOfMergingSemanticsNodes(
        unmergedChildren: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode>,
        list: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode> = mutableListOf(),
    ): List<com.huanli233.hibari2.core.semantics.SemanticsNode> {
        unmergedChildren.forEachUnmergedChild { child ->
            if (child.isMergingSemanticsOfDescendants) {
                list.add(child)
    ...
    private inline fun MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode>.forEachUnmergedChild(
        block: (com.huanli233.hibari2.core.semantics.SemanticsNode) -> Unit
    ) {
    ...
    // Fake nodes
    private fun emitFakeNodes(unmergedChildren: MutableList<com.huanli233.hibari2.core.semantics.SemanticsNode>) {
        ...
        if (
            unmergedConfig.contains(_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentDescription) &&
                unmergedChildren.isNotEmpty() &&
                unmergedConfig.isMergingSemanticsOfDescendants
        ) {
            val contentDescription =
                this.unmergedConfig.getOrNull(_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.ContentDescription)?.firstOrNull()
    ...
    private fun fakeSemanticsNode(
        role: com.huanli233.hibari2.core.semantics.Role?,
        properties: com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.() -> Unit,
    ): com.huanli233.hibari2.core.semantics.SemanticsNode {
        val configuration =
            ...
            com.huanli233.hibari2.core.semantics.SemanticsNode(
                outerSemanticsNode =
                    object : SemanticsModifierNode, Modifier.Node() {
                        override fun com.huanli233.hibari2.core.semantics.SemanticsPropertyReceiver.applySemantics() {
                            properties()
                        }
                    },
    ...
    internal fun copyWithMergingEnabled(): com.huanli233.hibari2.core.semantics.SemanticsNode {
        return com.huanli233.hibari2.core.semantics.SemanticsNode(
            outerSemanticsNode,
            true,
            layoutNode,
            unmergedConfig
...
private val com.huanli233.hibari2.core.semantics.SemanticsNode.role
    get() = this.unmergedConfig.getOrNull(_root_ide_package_.com.huanli233.hibari2.core.semantics.SemanticsProperties.Role)

private fun com.huanli233.hibari2.core.semantics.SemanticsNode.contentDescriptionFakeNodeId() = this.id + 2_000_000_000

private fun com.huanli233.hibari2.core.semantics.SemanticsNode.roleFakeNodeId() = this.id + 1_000_000_000
